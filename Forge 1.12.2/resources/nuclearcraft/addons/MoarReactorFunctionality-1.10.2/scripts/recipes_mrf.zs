...
for i,item in pebbles{
	mods.nuclearcraft.SolidFission.addRecipe(item,dpebbles[i],pebInts[i][0],pebInts[i][1],pebDoubles[i][0],pebInts[i][2],0/*fallback*/,fuelDecayFactor[i],pebPrime[i],pebDoubles[i][1]); // 153
}
