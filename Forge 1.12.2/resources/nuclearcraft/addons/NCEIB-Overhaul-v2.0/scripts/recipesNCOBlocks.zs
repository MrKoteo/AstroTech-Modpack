...
var blocks = {
feb: [<materialpart:ferroboron:block>, <ore:ingotFerroboron>], tough: [<materialpart:tough:block>, <ore:ingotTough>],
...
sic: [<materialpart:silicon_carbide:block>, <ore:ingotSiliconCarbide>],
...
steel: [<ore:blockSteel>, <nuclearcraft:alloy:5>], limno2: [<materialpart:lithium_manganese_dioxide:block>, <ore:ingotLithiumManganeseDioxide>],
mgb2: [<materialpart:magnesium_diboride:block>, <ore:ingotMagnesiumDiboride>], bronze: [<ore:blockBronze>, <nuclearcraft:alloy:0>],
...
si: [<ore:blockSilicon>, <ore:itemSilicon>], rhodo: [<materialpart:rhodochrosite:block>, <ore:gemRhodochrosite>],
villi: [<materialpart:villiaumite:block>, <ore:gemVilliaumite>], cs137: [<materialpart:caesium137:block>, <ore:ingotCaesium137>], 
...
tbp: [<materialpart:t_b_p:block>, <ore:ingotTBP>], cmn: [<materialpart:carbon_manganese:block>, <ore:ingotCarbonManganese>]
