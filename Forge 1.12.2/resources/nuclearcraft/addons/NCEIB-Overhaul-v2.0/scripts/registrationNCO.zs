...
var materials_blocks = [extreme_alloy,hard_carbon,ferroboron,limno2,hsla_steel,magnesium_diboride,sic_sic_cmc,lead_platinum,zircaloy,thermoconducting_alloy,silicon_carbide,
zirconium_molybdenum,tough_alloy,tin_silver,hastelloy,shibuichi,boron_arsenide,boron_nitride,carobbiite,fluorite,rhodochrosite,villiaumite] as Material[];
for mat in materials_blocks {
	mat.registerPart("block");
}

var materials_blocks_ingots = [caesium_137,europium_155,polonium,promethium_147,protactinium_233,radium,ruthenium_106,tbp,carbon_manganese] as Material[];
...
//molybdenum.registerPart("ingot");
strontium_90.registerPart("ingot");